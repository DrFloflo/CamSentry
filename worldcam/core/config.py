...
EXCLUSION_ZONE_DISPLAY_ENABLED = True
EXCLUSION_ZONE_PROCESSING_ENABLED = True
EXCLUSION_ZONE_EDIT_ENABLED = False
EXCLUSION_ZONE_POINTS = [(1279, 0), (1279, 365), (0, 387), (0, 0)]

EXCLUSION_ZONE_COLOR = (0, 0, 255)
EXCLUSION_ZONE_EDIT_COLOR = (0, 128, 255)
EXCLUSION_ZONE_HANDLE_COLOR = (255, 255, 255)
